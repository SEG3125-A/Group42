...
function populateListProductChoices(slct2) {
	...
	var restrictions = document.forms['restrictions'];
    var inputs = Array.from(restrictions.elements['restriction'])
    ...
    var optionArray = restrictListProducts(products, inputs);
